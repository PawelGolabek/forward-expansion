...
deck = [   
    ...
    instance_create_layer(0, -9999900, "Cards", o_explosive_drone_spawner),
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    ...
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    instance_create_layer(0, -9999900, "Cards", o_rebel_spawner),
    instance_create_layer(0, -9999900, "Cards", o_sniper_spawner),
    instance_create_layer(0, -9999900, "Cards", o_sniper_spawner),
    ...
    instance_create_layer(0, -9999900, "Cards", o_armored_drone_spawner),
    instance_create_layer(0, -9999900, "Cards", o_recall_spawner),
    instance_create_layer(0, -9999900, "Cards", o_hostile_recall_spawner),
    instance_create_layer(0, -9999900, "Cards", o_commander_spawner),
    instance_create_layer(0, -9999900, "Cards", o_katana_spawner),
    instance_create_layer(0, -9999900, "Cards", o_tank_spawner),
    instance_create_layer(0, -9999900, "Cards", o_katana_spawner),
];
